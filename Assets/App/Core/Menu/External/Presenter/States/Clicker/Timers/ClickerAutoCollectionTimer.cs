...
namespace App.Core.Menu.External.Presenter.States.Clicker.Timers
{
    public class ClickerAutoCollectionTimer : IDisposable
    {
        ...
        public ClickerAutoCollectionTimer(ClickerConfigController configController, Action timerTickCallback)
        {
        ...
        public void StartTimer()
        {
            ...
            m_Timer = Observable
                .Interval(TimeSpan.FromSeconds(m_ConfigController.GetAutoCollectionTimerInterval()))
